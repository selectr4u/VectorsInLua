...
-- Checks if the given parameter is a Vector3D object.
---@param a any
---@return boolean
...
-- Calculates the dot product of the current Vector3D object and another.
---@param v2 Vector3D
---@return number
...
-- Calculates the cross product of the current Vector3D object and another.
---@param v2 Vector3D
---@return Vector3D
...
-- Calculates the angle between the current Vector3D object and another.
---@param v2 Vector3D
---@return number
...
-- Calculates the distance between the current Vector3D object and another.
---@param v2 Vector3D
---@return number
...
-- Linearly interpolates between the current Vector3D object and another.
---@param v2 Vector3D
---@param t number
---@return Vector3D
...
-- Projects the current Vector3D object onto another.
---@param v2 Vector3D
---@return Vector3D
...
-- Reflects the current Vector3D object across a given normal.
...
-- Calculates the magnitude of the current Vector3D object.
---@return number
